...
4. Pre-fill Describe / Diagnose using only confirmed claims as
   asserted facts. Anything contradicted or unresolved becomes a
   noted uncertainty in the relevant phase, not a fact.

If the user says accept:

- Pre-fill phases as-is, but call out in the relevant phase that
  the non-trivial factual claims are inherited from the source and
  not verified this session. Naming the inheritance is honest and
